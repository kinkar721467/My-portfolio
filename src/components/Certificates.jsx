...
const certificates = [
  { 
    name: 'ChatGPT, Generative AI & LLM', 
    issuer: 'Infosys', 
    color: 'from-blue-600/20 to-cyan-500/20',
    link: 'https://drive.google.com/file/d/1Lw757mgddgxriqVsnJ3LICqao0Rsu21M/view'
  },
  { 
    name: 'Cloud Computing', 
    issuer: 'NPTEL', 
    color: 'from-purple-600/20 to-pink-500/20',
    link: 'https://archive.nptel.ac.in/content/noc/NOC25/SEM1/Ecertificates/106/noc25-cs11/Course/NPTEL25CS11S133730011904239059.pdf'
  },
  { 
    name: 'Computer Networking', 
    issuer: 'Coursera', 
    color: 'from-blue-600/20 to-indigo-500/20',
    link: 'https://coursera.org/verify/PA32G673LSP3'
  },
  { 
    name: 'Basic Python Programming', 
    issuer: 'Edusera', 
    color: 'from-[var(--color-primary)]/20 to-orange-500/20',
    link: 'https://drive.google.com/file/d/1LyQO7pIGU0A_JNUYjZyT-b-hWT___0NE/view'
  },
            ...
            {certificates.map((cert, index) => {
              ...
              return (
                ...
                >
                  ...
                  <CardWrapper 
                    {...wrapperProps}
                    className={`relative glassmorphism w-full h-full rounded-2xl p-8 border border-[var(--color-border)] hover:border-[var(--color-primary)] bg-[var(--color-secondary)] transition-all flex flex-col justify-between overflow-hidden ${cert.link ? 'cursor-pointer' : ''}`}
                  >
                    ...
                    <div className="relative z-10 pt-6 mt-4 border-t border-[var(--color-border)]/50">
                      <div className="flex items-center justify-between">
                        ...
                        {cert.link && (
                          <FaExternalLinkAlt className="text-[var(--color-text-muted)] group-hover:text-[var(--color-primary)] transition-colors" size={14} />
                        )}
                      </div>
                    </div>
                  </CardWrapper>
